...
public class UpdateAccountController {
	...
	public String updateUsername(@ModelAttribute("appUserDTO") AppUserDTO appUserDTO, HttpServletRequest request, HttpServletResponse response) {
		HttpSession session = request.getSession();
		session.removeAttribute("successfull_update");
		session.removeAttribute("unsuccessfull_update");
	...
	public String updatePassword(@ModelAttribute("appUserDTO") AppUserDTO appUserDTO, HttpServletRequest request) {
		...
		session.removeAttribute("successfull_update");
		session.removeAttribute("unsuccessfull_update");
		String result = updateAccountService.updatePassword(appUserDTO.getOldPassword(), appUserDTO.getNewPassword(), appUserDTO.getOldUsername());
		if(!result.startsWith("Error")) {
