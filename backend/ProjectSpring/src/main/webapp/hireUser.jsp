...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/style/hireUser.css">
</head>
<body>
<div class="nav-buttons">
	...
	<c:if test="${!empty result}">
		<div class="messsage-box">${result }</div>
	</c:if>
	<form action="/ProjectRIS/manager/hire-user" method="post" class="center-form">
